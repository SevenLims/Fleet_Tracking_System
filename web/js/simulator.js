...
const IOT_ENDPOINT = 'a16dhgih2l662v-ats.iot.ap-southeast-2.amazonaws.com'; 
const TOPIC = 'fleet/location'; // Topic Name
const REGION = 'ap-southeast-2';
const IDENTITY_POOL_ID = 'ap-southeast-2:aab54ccb-a259-4e8a-b369-658856224186';
var iotData = null;
...
// Four Trucks (devices) with initial locations
...
theDevice4 = new Device('Truck-4', 36.198110, -115.1791);

//Save them in a array
const deviceArray = [];
deviceArray.push(theDevice1, theDevice2, theDevice3, theDevice4);
...
function initialize() {
    ...
    const identityPoolId = 'ap-southeast-2:aab54ccb-a259-4e8a-b369-658856224186';
